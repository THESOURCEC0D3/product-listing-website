...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="flex flex-col space-y-3 items-center border rounded-2xl shadow-2xl shadow-gray-500 p-3 hover:scale-110 hover:border-blue-400 hover:shadow-2xl hover:shadow-purple-500 hover:z-30 bg-white transition-all duration-500 z-10 cursor-pointer">
